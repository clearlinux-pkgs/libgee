...
Source0  : https://download.gnome.org/sources/libgee/0.20/libgee-0.20.4.tar.xz
...
%prep
%setup -q -n libgee-0.20.4
cd %{_builddir}/libgee-0.20.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616113549
...
cp %{_builddir}/libgee-0.20.4/COPYING %{buildroot}/usr/share/package-licenses/libgee/caeb68c46fa36651acf592771d09de7937926bb3
%make_install
