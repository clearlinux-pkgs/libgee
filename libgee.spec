...
Source0  : https://download.gnome.org/sources/libgee/0.20/libgee-0.20.5.tar.xz
...
%prep
%setup -q -n libgee-0.20.5
cd %{_builddir}/libgee-0.20.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644536444
...
cp %{_builddir}/libgee-0.20.5/COPYING %{buildroot}/usr/share/package-licenses/libgee/caeb68c46fa36651acf592771d09de7937926bb3
%make_install
